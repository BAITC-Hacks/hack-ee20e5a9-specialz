...
```bash
pip install -r requirements.txt scipy pyvis
...
- Точная betweenness и отображение всей сети PyVis могут стать узкими местами на больших данных. CLI формирует CSV; интерактивная визуализация и поиск реализованы в ноутбуке.
